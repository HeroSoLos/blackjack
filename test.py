...
class BlackjackGame(tk.Tk):
    ...
    def setup_ui(self):
        ...
        # Turn off Auto-Bet Button
        self.disable_auto_bet_button = tk.Button(self, text="Turn Off Auto-Bet", command=self.disable_auto_bet)
        self.disable_auto_bet_button.pack(pady=5)
        ...
        self.ai_button = tk.Button(button_frame, text="AI Advisor (-10%)", command=self.ai_advisor, state=tk.DISABLED, font=("Arial", 14), width=12)
    ...
    def disable_auto_bet(self):
        self.auto_bet_percent = 0
        self.show_outcome("Auto-Bet disabled.", "red")
